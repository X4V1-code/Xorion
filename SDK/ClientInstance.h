...
public:
    ...
    void computeHash() {
        ...
        if (this->text.getTextLength() <= 0) return;
    ...
    unsigned __int64 getHash() { return this->hash; }
};
...
public:
    __int64* getClientTexture() { return this->clientTexture; }
};
struct MaterialPtr {
private:
...
public:
    ...
    Font* getMCFont() { return mcFont; }
    bool canUseKeybinds() { return canUseKeys; }
...
public:
    ...
    glmatrixf* getRefDef() { return reinterpret_cast<glmatrixf*>((uintptr_t)(this) + 0x300); };
    Vec2* getMousePos() { return reinterpret_cast<Vec2*>((uintptr_t)(this) + 0x468); }
    ...
    Font* _getFont() { return this->getFont(); }
    Font* _getRuneFont() { return this->getRuneFont(); }
    Font* _getUnicodeFont() { return this->getUnicodeFont(); }

    void grabMouse() { return Utils::CallVFunc<304, void>(this); }
    void releaseMouse() { return Utils::CallVFunc<305, void>(this); }
